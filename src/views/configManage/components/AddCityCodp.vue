  ...
  <div>
    ...
    >
      <div class="flexBox flex-col">
        <div class="item flexBox flex-row flex-middle pac-mb12x">
          <div class="flex-1 flexBox flex-row flex-middle">
            <div class="labelItem"><span class='redIcon'>*</span>名称：</div>
      ...
      <span slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" @click="submit" :disabled='!req.areaCode||!req.areaName'
          >确 定</el-button
        >
      </span>
    </el-dialog>
...
export default {
  ...
  methods: {
    ...
    submit () {
      if (!this.req.areaCode || !this.req.areaName || !this.req.type) {
